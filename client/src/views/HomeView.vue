...
<template>
  <header>
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
      <div class="flex text-center justify-between items-center mx-auto max-w-screen-xl">
        <a href="/" class="flex items-center ">
          <img src="https://flowbite.com/docs/images/logo.svg" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
          <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">PainTasker</span>
        </a>
        <div class="flex items-center order-1 lg:order-2">
          <a href="/login"
            class="text-gray-800 text-xs lg:text-sm dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Přihlásit
            se</a>
          <a href="/register"
            class="text-white text-xs lg:text-sm bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Registrovat
            se</a>
        </div>
  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
      <a href="#"
        ...
        role="alert">
        <span class="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3">Novinka</span> <span
          class="text-sm font-medium">Vyšla nám verze 1.0 PainTaskeru</span>
      ...
      <h1
        ...
        Turning your Tasks into Pain</h1>
      <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Úkolníček, který
        promění vaše úkoly v bolest, abyste mohli dosáhnout svých cílů s odhodláním a bolestí. Ovládněte své úkoly a
        získávejte bolest z jejich dokončení!</p>
      <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
        <a href="https://github.com/Pain-Software"
      ...
      <div class="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
        <span class="font-semibold text-gray-400 uppercase">POUŽÍVÁ NÁS</span>
      ...
      <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
        ...
        <div
          ...
          <div class="flex justify-center items-baseline my-8">
            <span class="mr-2 text-5xl font-extrabold">290 CZK</span>
            <span class="text-gray-500 dark:text-gray-400">/měsíc</span>
          </div>
          <!-- List -->
        ...
        <div
          ...
          <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Relevant for multiple users, extended &
            premium support.</p>
          <div class="flex justify-center items-baseline my-8">
            <span class="mr-2 text-5xl font-extrabold">999 CZK</span>
            <span class="text-gray-500 dark:text-gray-400">/měsíc</span>
          </div>
          <!-- List -->
          <ul role="list" class="mb-8 space-y-4 text-left">
        ...
        <div
          ...
          <div class="flex justify-center items-baseline my-8">
            <span class="mr-2 text-5xl font-extrabold">9999 CZK</span>
            <span class="text-gray-500 dark:text-gray-400">/měsíc</span>
          </div>
          <!-- List -->
          <ul role="list" class="mb-8 space-y-4 text-left">
    ...
    <div class="mx-auto max-w-screen-xl">
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
          <a href="https://flowbite.com" class="flex items-center">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">PainTasker</span>
          </a>
        </div>
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Zdroje</h2>
          ...
          <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Sleduj mě</h2>
            <ul class="text-gray-600 dark:text-gray-400">
              <li class="mb-4">
                <a href="https://github.com/pavelvachaaa" class="hover:underline ">Github</a>
              </li>
              <li>
                <a href="https://www.instagram.com/p.vacha1/" class="hover:underline">Instagram</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul class="text-gray-600 dark:text-gray-400">
              <li class="mb-4">
                <a href="#" class="hover:underline">Neřeším</a>
              </li>
              <li>
                <a href="#" class="hover:underline">Podmínky &amp; Použití</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#"
            class="hover:underline">PainSoftware™</a>. Všechna práva vyhrazena.
        </span>
