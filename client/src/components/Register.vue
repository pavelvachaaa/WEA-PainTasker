                        ...
                        <form class="space-y-4 md:space-y-6" @submit.prevent="register">
                            <div>
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    placeholder="Norbert Kný" required="" v-model="form.name">
                            </div>
                            <div>
                                <label for="email"
                            ...
                            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                Máte již účet? Přihlašte se <a href="/login"
                                    class="font-medium text-primary-600 hover:underline dark:text-primary-500">zde</a>
                            </p>
                        </form>
                    </div>
                </div>
